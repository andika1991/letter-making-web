...
class SuratIzinOrangTuaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('dashboard/SuratIzinOrangTua')->with('success', 'Surat izin berhasil dibuat.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('dashboard/SuratIzinOrangTua')->with('success', 'Surat izin berhasil dihapus.');
    }
