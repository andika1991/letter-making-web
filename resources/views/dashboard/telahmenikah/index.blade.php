...
<div class="container-fluid pt-4 px-4">
    <div class="bg-light text-center rounded p-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            <a href="/dashboard/telahmenikah/create" class="btn btn-primary">Tambah SPPH</a>
        </div>
            ...
            <table class="table text-start align-middle table-bordered table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-primary" href="/dashboard/telahmenikah/{{ $telahmenikahs->id }}">Detail</a>
                            <a class="btn btn-sm btn-warning" href="/dashboard/telahmenikah/{{ $telahmenikahs->id }}/edit">Edit</a>
