...
<body>
    <center>
        ...
        <table class="tanggal-surat" style="width: 100%; margin-top: 10px;">
            <tr>
                <td style="text-align: right;">Sumber Bahagia, {{ \Carbon\Carbon::parse($surat->created_at)->translatedFormat('d F Y') }}</td>
            </tr>
        </table>
