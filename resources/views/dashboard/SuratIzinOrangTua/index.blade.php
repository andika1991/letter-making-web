            ...
            <table class="table text-start align-middle table-bordered table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-primary" href="/dashboard/suratIzinOrtu/{{ $surat->id }}">Detail</a>
                            <a class="btn btn-sm btn-warning" href="/dashboard/suratIzinOrtu/{{ $surat->id }}/edit">Edit</a>
